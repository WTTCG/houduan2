...
public class JdbcTemplateTest {
    ...
    public void testDelete(){
        ...
        int affectedRow=jdbcTemplateDao.delete(6);
    ...
    public void testUpdate(){
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("applicationContext.xml");
        JDBCTemplateDaoImpl jdbcTemplateDao = applicationContext.getBean(JDBCTemplateDaoImpl.class);
        int affectedRow=jdbcTemplateDao.update(new User(6,null,"888"));
        System.out.println(affectedRow);
    }
    @Test
    public void testInsert(){
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("applicationContext.xml");
        JDBCTemplateDaoImpl jdbcTemplateDao = applicationContext.getBean(JDBCTemplateDaoImpl.class);
        int affectedRow=jdbcTemplateDao.insert(new User(null,"ltsc","666"));
        System.out.println(affectedRow);
    }
    @Test
