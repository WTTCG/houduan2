...
public class ResponseController {
    ...
    public ModelAndView testModelAndView() {
        ...
        //request.getRequestDispatcher("/success.jap").forward(req,resp);
    ...
    public String testStringForward(Model model) {
        model.addAttribute("user", "唔西迪西");
        return "forward:/success.jsp";
    }

    //ResponseBody会自动跳过视图解析器
    //并且返回json类型的数据
    ...
    public String testHtmlString() {
        return "<h1 align='center' style='color:red'>易烊千玺<h1>";
    }
